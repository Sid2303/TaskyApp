...
const state = {
    ...
    <div class="col-md-6 col-lg-4 mt-3" id=${id} key=${id}>
      <div class='card shadow-sm task__card'>
        ...
        <div class='card-header d-flex justify-content-end task__card__header gap-2 '>
            <button type='button' class='btn btn-outline-primary mr-4' name=${id} onclick="editTask.apply(this, arguments)">
        ...
        <div class='card-body'>
            ${
              ...
              :
              `<img width='100%' src=${"https://storage.googleapis.com/proudcity/mebanenc/uploads/2021/03/placeholder-image.png"} alt='Card Image' class='card-img-top md-3 rounded-lg' />`
            }
  ...
  const deleteTask = (e) => {
    ...
    const parentNode = e.target.closest('.col-md-6'); // Find the closest parent with class 'col-md-6'
    ...
    taskContents.innerHTML = ""; // Clear the taskContents
